...
class Menu(object):
	...
	class PageItem(object):
		def __init__(self, code, item, direction):
	...
	def addPageItem(self, page_code, item, direction = "NO_IMPLEMENT" ):
		"""
		...
		if direction not in ('next', 'previous'):
			raise IndexError, "param @direction must be either 'next' or 'previous'"
		
		self.page_items[direction] = PageItem(page_code, item, direction))
		"""
